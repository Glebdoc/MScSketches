...
performance_key = "thrust"  # key to extract from performance.json (optional, collected but unused below)
# ------------------------------
...
for i in range(121):
    ...
    try:
        ...
        performance_values.append(performance_data.get(performance_key, np.nan)*3)
...
print('Max index performance value:', np.argmax(performance_values))
