...
small_props_angles = (0, -np.pi/2, 0)  # Initial rotation angles (e.g., Euler angles)
small_props_diameters = 0.2
small_props_NB = 3
...
drone.display(color_main='blue', color_small='red')
# # Translate the drone
# drone.translate([0, 0, 10])  # Move the drone 10 units along the Z-axis

# # Rotate the drone
# drone.rotate(0, np.pi/4, 0)  # Rotate the drone 45 degrees around the Y-axis
